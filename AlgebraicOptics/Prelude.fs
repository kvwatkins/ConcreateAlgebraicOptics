...
(*=========================================================================================================================================*)
    ...
    type AlgebraicLens<'s,'t,'a,'b> = AlgebraicLens of ('s -> 'a) * ('s list -> 'b -> 't option) with
        member this.view = match this with AlgebraicLens(view,_) -> view
        member this.classify = match this with AlgebraicLens(_,classify) -> classify
